...
},{"./log":9,"./main":10}],2:[function(require,module,exports){
...
var IFramePhoneWrapper, iframePhone, l,
...
module.exports = IFramePhoneWrapper = (function() {
  IFramePhoneWrapper.instances = {};

  IFramePhoneWrapper.instance = function($iframe) {
    var base;
  ...
  IFramePhoneWrapper.KNOWN_PARENT_MSGS = "setLearnerUrl interactiveState getAuthInfo extendedSupport htmlFragResponse".split(/\s+/);

  IFramePhoneWrapper.prototype.restart = function($iframe) {
    if (this.iframePhone) {
    ...
    this.iframePhone = new iframePhone.ParentEndpoint($iframe[0], this.phone_answered.bind(this));
  ...
  function IFramePhoneWrapper($iframe) {
    this.receiveMessage = bind(this.receiveMessage, this);
    this.restart($iframe);
  }

  IFramePhoneWrapper.prototype.handlePhoneMessage = function(msg, data, args) {
    var i, len, listener, ref, results;
    l.info(msg + " called with: " + data);
    $('#dataIn').html(JSON.stringify(data, null, "  "));
    if (this.listeners[msg]) {
      ref = this.listeners[msg];
      results = [];
      for (i = 0, len = ref.length; i < len; i++) {
        listener = ref[i];
        results.push(listener(msg, data));
      }
      return results;
    }
  };

  IFramePhoneWrapper.prototype.addListener = function(msg, func) {
    var base;
    if ((base = this.listeners)[msg] == null) {
      base[msg] = [];
    }
    return this.listeners[msg].push(func);
  };
  ...
  IFramePhoneWrapper.prototype.formatMsg = function(msg) {
    var error, message;
    message = "";
    try {
  ...
  IFramePhoneWrapper.prototype.receiveMessage = function(msg) {
    return l.info(this.formatMsg(msg));
  };

  IFramePhoneWrapper.prototype.addWindowListener = function() {
    return window.addEventListener("message", this.receiveMessage.bind(this), false);
  };

  return IFramePhoneWrapper;

})();



},{"./log":9,"iframe-phone":6}],9:[function(require,module,exports){
var Log, log;
...
},{"loglevel":7}],10:[function(require,module,exports){
var Main, Phone, Proxy, l, m;
...
Main = (function() {
  function Main(x) {
    this.x = x;
    l.info("built with " + this.x);
    this.setUpButtons();
    this.proxy = new Proxy();
    this.phone = Phone.instance($("#interactive-iframe"));
  }

  Main.prototype.setUpButtons = function() {
    var $b, bindButton, button, buttons, functionName, i, len, results;
    buttons = "saveInteractive loadInteractive takeSnapshot htmlFragRequest getLearnerUrl getExtendedSupport sendAuthInfo".split(/\s+/);
    l.info("loading buttons");
    bindButton = (function(_this) {
      return function($$, name) {
        return $$.on("click", function(e) {
          return _this.proxy[name](e);
        });
      };
    })(this);
    results = [];
    for (i = 0, len = buttons.length; i < len; i++) {
      ...
      results.push(bindButton($b, functionName));
    }
    return results;
  };
...
},{"./iframe-phone-wrapper":8,"./log":9,"./proxy":11}],11:[function(require,module,exports){
var Phone, Proxy, l;
...
module.exports = Proxy = (function() {
  ...
  Proxy.prototype.saveInteractive = function(e) {
    l.warn("saveInteractive called in proxy");
    return this.phone.post("getInteractiveState");
  };

  Proxy.prototype.loadInteractive = function(e) {
    l.warn("loadInteractive called in proxy");
    return this.phone.post("loadInteractive", $('dataOut').val());
  };

  Proxy.prototype.htmlFragRequest = function(e) {
    l.warn("htmlFragRequest called in proxy");
    return this.phone.post("htmlFragRequest");
  };

  Proxy.prototype.takeSnapshot = function(e) {
    l.warn("takeSnapshot called in proxy");
    return this.phone.post("takeSnapshot");
  };

  Proxy.prototype.getLearnerUrl = function(e) {
    l.warn("getLearnerUrl called in proxy");
    return this.phone.post("getLearnerUrl");
  };

  Proxy.prototype.getExtendedSupport = function(e) {
    l.warn("getExtendedSupport called in proxy");
    return this.phone.post("getExtendedSupport");
  };

  Proxy.prototype.sendAuthInfo = function(e) {
    l.warn("sendAuthInfo called in proxy");
    return this.phone.post("sendAuthInfo");
  };
...
},{"./iframe-phone-wrapper":8,"./log":9}]},{},[1]);
